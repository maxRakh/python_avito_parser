...
def get_data(url):
    """
    :param url: url from avito.ru with options for search
    ...
    try:
        ...
        for ad in all_ad_on_page:
            ...
            try:
                ad_address = ad.find_element(By.CSS_SELECTOR, 'span[class*="geo-address"] > span').text + ad.find_element(By.CSS_SELECTOR, 'div[class*="geo-georeferences"] > span > span').text
            except:
            ...
            ad_dict.append({
                ...
                "ad_url": ad_url,
                "ad_price": ad_price,
                "ad_descr_title": ad_descr_title,
                "ad_unit_price": ad_unit_price,
                "ad_address": ad_address,
                "ad_publ_time": ad_publ_time,
                "phone_num": phone_num
            })
            count += 1
            print(f"Обрабобтано объявлений: {count} из 50")
        ...
        # Помещаем все данные в csv файл
        with open(f"avito_search_{cur_time}.csv", "a", encoding="utf-8") as csv_file:
...
def main():
    get_data("https://www.avito.ru/moskovskaya_oblast/zemelnye_uchastki/prodam/izhs-ASgBAQICAUSWA9oQAUCmCBTmVQ?f=ASgBAQECAUSWA9oQAUCmCBTmVQNFlAkZeyJmcm9tIjoxNDM4NCwidG8iOjE0Mzg3fbgTGHsiZnJvbSI6bnVsbCwidG8iOjE0NDU0fcaaDBd7ImZyb20iOjAsInRvIjoyMDAwMDAwfQ&moreExpensive=1&road=32&s=104")
